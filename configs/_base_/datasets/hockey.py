...
dataset_info = dict(
    ...
    skeleton_info={
        ...
        12: dict(link=("neck", "left_shoulder"), id=12, color=[51, 153, 255]),
        13: dict(link=("neck", "right_shoulder"), id=13, color=[51, 153, 255]),
        14: dict(link=("neck", "head"), id=14, color=[51, 153, 255]),
        # 15: dict(link=("hockey_grip", "hockey_hill"), id=15, color=[51, 153, 255]),
    },
    # TODO Tune this
    joint_weights=[
        1.0,
