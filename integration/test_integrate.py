...
if __name__=='__main__':
	...
	matcher = posematcher.PoseMatcher(top_down_path='./mupots/pred/',btm_up_path='./mupots/MUPOTS_Preds_btmup_transformed.pkl')
	matcher.match(pts_out_path='./mupots/pred_bu/')

	## step 2: infer the integrated results 
	print('Inferring the integrated poses...')
	# create data loader 
	data = inteutil.InteDataset(bu_path='./mupots/pred_bu/',td_path='./mupots/pred/')
